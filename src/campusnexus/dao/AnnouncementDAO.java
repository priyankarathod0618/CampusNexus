...
public class AnnouncementDAO {
    ...
    // AND/OR/IS NULL operators: matches announcements aimed at everyone OR this student's branch/year
    public List<Announcement> findRelevantForStudent(int collegeId, String branch, int year)
            throws SQLException {
    ...
    JOIN teacher_profiles tp
        ON a.teacher_id = tp.user_id
    JOIN users u
        ON tp.user_id = u.id
    WHERE tp.college_id = ?
      AND (a.target_branch IS NULL OR a.target_branch = ?)
